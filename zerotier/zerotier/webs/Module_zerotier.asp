...
function get_ztnets_status(){
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_ztnets.sh", "params":[1], "fields": ""};
	$.ajax({
		type: "POST",
		cache: false,
		url: "/_api/",
...
function get_ifaces_status(){
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_ifaces.sh", "params":[1], "fields": ""};
	$.ajax({
		type: "POST",
		cache: false,
		url: "/_api/",
...
function save(){
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_config.sh", "params": ["web_submit"], "fields": dbus_new};
	$.ajax({
		type: "POST",
		url: "/_api/",
		data: JSON.stringify(postData),
...
function leave_network(o){
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_config.sh", "params": ["leave_network"], "fields": dbus_new};
	$.ajax({
		type: "POST",
		url: "/_api/",
		data: JSON.stringify(postData),
...
function deorbit_moon(){
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_config.sh", "params": ["deorbit_moon"], "fields": dbus_new};
	$.ajax({
		type: "POST",
		url: "/_api/",
		data: JSON.stringify(postData),
...
function orbit_moon(){
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_config.sh", "params": ["orbit_moon"], "fields": dbus_new};
	$.ajax({
		type: "POST",
		url: "/_api/",
		data: JSON.stringify(postData),
...
function join_network(){
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_config.sh", "params": ["join_network"], "fields": dbus_new};
	$.ajax({
		type: "POST",
		url: "/_api/",
		data: JSON.stringify(postData),
...
function open_peers_info() {
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_peerss.sh", "params":[], "fields": ""};
	$.ajax({
		type: "POST",
		cache:false,
		url: "/_api/",
...
function get_moons_status() {
	// get snap file
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_lsmoon.sh", "params":[1], "fields": dbus};
	$.ajax({
		type: "POST",
		async: true,
		cache: false,
...
function apply_uppoaded_moon(Info) {
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "zerotier_config.sh", "params": ["upload_moon"], "fields": Info };
	$.ajax({
		type: "POST",
		url: "/_api/",
		data: JSON.stringify(postData),
