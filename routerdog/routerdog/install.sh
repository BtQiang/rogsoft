...
chmod +x /koolshare/scripts/routerdog*
chmod +x /koolshare/scripts/uninstall_routerdog.sh

# 离线安装用
dbus set routerdog_version="$(cat $DIR/version)"
dbus set softcenter_module_routerdog_version="$(cat $DIR/version)"
dbus set softcenter_module_routerdog_description="路由狗，路由看家好帮手~"
dbus set softcenter_module_routerdog_install="1"
dbus set softcenter_module_routerdog_name="routerdog"
dbus set softcenter_module_routerdog_title="路由狗"
